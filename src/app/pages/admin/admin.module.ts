...
@NgModule({
  declarations: [AdminComponent, AdminSidebarComponent, AdminFooterComponent, AdminStudentsAllCoursesComponent, ConfirmComponent, AdminInstructorsListComponent, AdminConfirmCoursesComponent, RestrictedUsersComponent, AdvancedSearchPaymentStudentComponent, ManagmentUserComponent, EditUserComponent, CreateCourseComponent, AddChapterComponent, AddLectureComponent],
  imports: [
    CommonModule,
    AdminRoutingModule,
    CommonModule,
